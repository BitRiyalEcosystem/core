...
echo 'alias bitriyal="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/BitRiyalEcosystem/core" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/BitRiyalEcosystem/core'"
...
rm -rf "$HOME/.config/@bitriyal"
rm -rf "$HOME/.config/@bitriyal"
rm -rf "$HOME/.config/bitriyal-core"
